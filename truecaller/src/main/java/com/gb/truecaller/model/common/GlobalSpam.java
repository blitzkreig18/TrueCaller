...
import static com.rbm.truecaller.model.common.Constant.MAX_COUNT_TO_MARK_GLOBAL_BLOCKED;
import static com.rbm.truecaller.model.common.Constant.MAX_GLOBAL_SPAM_COUNT;
...
public class GlobalSpam {
    ...
    private CountinrbmloomFilter<String> globalSpam =
            new FilterBuilder(MAX_GLOBAL_SPAM_COUNT, .01)
                    .buildCountinrbmloomFilter(
                    );
